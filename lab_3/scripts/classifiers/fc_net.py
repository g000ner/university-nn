...
class TwoLayerNet(object):
    ...
    def __init__(self, input_dim=3 * 32 * 32, hidden_dim=100, num_classes=10, weight_scale=1e-3, reg=0.0,):
        ...
        # два слоя, запомнили их размерности и зарандомили веса
        self.num_layers = 2
    ...
    def loss(self, X, y=None):
        ...
        caches = {}
        scores = X
        # прямой проход для случая, если слой последний и не последний
        ...
        # ошибка и градиент при обратном проходе для двух случаев
    ...
    def train(self, X, y, X_val, y_val,
        ...
        # SGD для оптимизации параметров в этой модели
        loss_history = []
        train_acc_history = []
        val_acc_history = []
        ...
        for it in range(num_iters):
            ...
            # случайная минипакетная выборка обучающих данных и меток
            batch_idxes = np.random.choice(num_train, batch_size, replace=True)
            X_batch = X[batch_idxes, :]
            y_batch = y[batch_idxes]

            # потери и градиенты с использованием текущей минипакетной выборки
            ...
            # проверяем точность на обучающем и валидационном наборах
            # и уменьшаем скорость обучения на каждой эпохе
    ...
    def predict(self, X):
        ...
        #класс с наивысшей оценкой для каждой точки данных
...
class FullyConnectedNet(object):
    ...
    def __init__(self, hidden_dims, input_dim=3 * 32 * 32, num_classes=10, 
        ...
        # инициализация как и в случае 2-слойной
